...
pretrain_self_data=$data_dirname/${random_seed}/pretrain-self/data-bin
...
rm -rf $data_dirname/${random_seed}/pretrain-self/
mkdir -p $data_dirname/${random_seed}/pretrain-self/
cd $data_dirname/${random_seed}/pretrain-self/
